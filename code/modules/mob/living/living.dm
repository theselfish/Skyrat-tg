...
/mob/living/proc/makeTrail(turf/target_turf, turf/start, direction)
	...
	var/blood_exists = locate(/obj/effect/decal/cleanable/blood/trail_holder) in start // SKYRAT EDIT CHANGE
	...
	if(!blood_exists)
		new /obj/effect/decal/cleanable/blood/trail_holder(start, get_static_viruses()) // SKYRAT EDIT CHANGE

	for(var/obj/effect/decal/cleanable/blood/trail_holder/TH in start) // SKYRAT EDIT CHANGE
